  ...
  return (
    <>
      <section className="mx-auto max-w-[1120px] px-5 pb-5 pt-12 sm:px-8 sm:pt-16 lg:px-14 lg:pt-20">
        ...
        <h1 className="mb-5 font-serif text-3xl font-medium text-ink sm:text-4xl lg:text-[42px]">
          Programs, launches, and the odd rescue mission.
        </h1>
        <p className="mb-10 max-w-[600px] text-base leading-relaxed text-bodyMuted sm:mb-14 sm:text-[17px]">
