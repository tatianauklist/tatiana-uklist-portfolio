...
export default function AboutPage() {
  return (
    <section className="mx-auto grid max-w-[1000px] grid-cols-[1fr_1.3fr] items-start gap-14 px-14 pb-[120px] pt-20">
      <div>
        <StripeThumb variant="a" label="PORTRAIT" className="h-[340px] border border-borderDashed" />
      ...
      <div>
        ...
        <h1 className="mb-[26px] font-serif text-4xl font-medium text-ink">Hi, I&apos;m Tatiana.</h1>
